TriggerEvent('es:addGroupCommand', 'tp', 'admin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/tp', x .. " " .. y .. " " .. z)
...
TriggerEvent('es:addGroupCommand', 'setjob', 'mod', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/setjob', xPlayer.getName() .. " " .. args[2] .. " " .. args[3])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'loadipl', 'admin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/loadipl', ESX.GetPlayerFromId(args[1]).getName())
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'unloadipl', 'admin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/unloadipl', ESX.GetPlayerFromId(args[1]).getName())
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'playanim', 'admin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/playanim', args[1] .. " " .. args[3])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'playemote', 'admin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/playemote', args[1])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'car', 'mod', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/car', args[1])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'cardel', 'admin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/cardel', " ")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'dv', 'mod', function(source, args, user)
	TriggerClientEvent('esx:deleteVehicle', source)
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/dv', " ")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end, {help = _U('delete_vehicle')})
...
TriggerEvent('es:addGroupCommand', 'spawnped', 'superadmin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/spawnped', args[1])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'spawnobject', 'superadmin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/spawnobject', args[1])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'setmoney', 'superadmin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(_source), '/setmoney', xPlayer.getName() .. " " .. args[2] .. " " .. args[3])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'giveaccountmoney', 'superadmin', function(source, args, user)
	...
	if amount ~= nil then
		if xPlayer.getAccount(account) ~= nil then
			...
			exports['JD_logs']:discord(GetPlayerName(xPlayer.source)..' gaf aan: '..GetPlayerName(args.playerId).." **"..ESX.Math.GroupDigits(args.amount)..' '..args.account..'**', xPlayer.source, args.playerId, '#000000', 'givemoney')
		else
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(_source), '/giveaccountmoney', xPlayer.getName() .. " " .. args[2] .. " " .. args[3])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'giveitem', 'superadmin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(_source), '/giveitem', xPlayer.getName() .. " " .. args[2] .. " " .. count)
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'giveweapon', 'superadmin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/giveweapon', xPlayer.getName() .. " " .. args[2] .. " " .. args[3])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'disc', 'admin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/disc', " ")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end)
...
TriggerEvent('es:addGroupCommand', 'disconnect', 'admin', function(source, args, user)
	DropPlayer(source, 'You have been disconnected')
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/disconnect', " ")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'clear', 'user', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/clear', " ")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'cls', 'user', function(source, args, user)
	TriggerClientEvent('chat:clear', source)
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/cls', " ")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end)
...
TriggerEvent('es:addGroupCommand', 'clsall', 'admin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/clsall', " ")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end)
...
TriggerEvent('es:addGroupCommand', 'clearall', 'admin', function(source, args, user)
	TriggerClientEvent('chat:clear', -1)
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/clearall', " ")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'clearinventory', 'superadmin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/clearinventory', xPlayer.getName())
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'clearloadout', 'superadmin', function(source, args, user)
	...
	TriggerEvent('7DiscordLog:CommandLog', ESX.GetPlayerFromId(source), '/clearloadout', xPlayer.getName())
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
